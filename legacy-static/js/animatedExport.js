import { compositeCanvas, drawOverlayLabels } from "./exportImage.js?v=21";
...
function generateFrames(mapA, mapB, frameCount, maxWidth, labels) {
  const frames = [];
...
export async function exportCompareGif({
  mapA, mapB, durationMs = 2400, fps = 17, maxWidth = 640, quality = 0.7, labels, onProgress
} = {}) {
...
export async function exportCompareWebm({
  mapA, mapB, durationMs = 3000, fps = 24, maxWidth = 640, quality = 0.7, labels, onProgress
} = {}) {
