import { SH_INSTANCE_ID, MODE_LAYERS } from "./config.js?v=21";
 ...
 * Callers resolve which date to request via stacInfo.findSceneInfo() first
 ...
 * wildfire scene).
 */
export function wmtsTileUrl(mode, timeRange, { maxCloud = 100, priority = "mostRecent" } = {}) {
...
export function dayRange(isoDateTime) {
